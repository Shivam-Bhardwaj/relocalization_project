...
if __name__ == '__main__':
    ...
    parser.add_argument('--metadata_path', type=str, default='../KingsCollege/dataset_train.txt')

    # Training settings
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0 1 2 3')
    parser.add_argument('--num_epochs', type=int, default=599)
    parser.add_argument('--num_epochs_decay', type=int, default=50)
    parser.add_argument('--batch_size', type=int, default=100) # 16
