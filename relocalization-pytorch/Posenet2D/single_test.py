...
if __name__ == '__main__':
    ...
    parser.add_argument('--mode', type=str, default='single', choices=['train', 'test', 'single'])
    ...
    # parser.add_argument('--image_path', type=str, default='KingsCollege')
    # parser.add_argument('--metadata_path', type=str, default='KingsCollege/dataset_test.txt')
    parser.add_argument('--image_path', type=str, default='dataset/test')
    parser.add_argument('--metadata_path', type=str, default='dataset/test/test.txt')
    # parser.add_argument('--metadata_path', type=str, default='KingsCollege/single.txt')
    # Training settings
