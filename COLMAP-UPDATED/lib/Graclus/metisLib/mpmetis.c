...
void METIS_mCPartGraphRecursiveInternal(int *nvtxs, int *ncon, idxtype *xadj, idxtype *adjncy,
                                        float *nvwgt, idxtype *adjwgt, int *nparts, int *options, int *edgecut,
                                        idxtype *part) {
    int i, j;
    GraphType graph;
    CtrlType ctrl;
...
void METIS_mCHPartGraphRecursiveInternal(int *nvtxs, int *ncon, idxtype *xadj, idxtype *adjncy,
                                         float *nvwgt, idxtype *adjwgt, int *nparts, float *ubvec, int *options,
                                         int *edgecut,
                                         idxtype *part) {
    int i, j;
    GraphType graph;
...
int MCMlevelRecursiveBisection(CtrlType *ctrl, GraphType *graph, int nparts, idxtype *part,
    ...
    GKfree((void **) &graph->gdata, (void **) &graph->nvwgt, (void **) &graph->rdata, (void **) &graph->npwgts,
