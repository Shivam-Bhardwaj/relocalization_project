...
class Solver():
    def __init__(self, data_loader, config):
        ...
        self.model_save_path = 'data/models_%s' % self.data_name
        # self.model_save_path = 'models_NCLT_cam4_2seqs_3m'
        self.summary_save_path = 'data/summary_%s' % self.data_name
    ...
    def test(self):
        ...
        if self.config.save_result:
            f_true = 'data/pose_true.csv'
            f_estim = 'data/pose_estim.csv'
    ...
    def single(self):
        ...
        def xyz_rot(pos, ori):
            ...
            xyz_ = np.matmul(rot_neg, pos)
            angle_ = np.matmul(rot, [1.0, 1.0, 1.0])
            return xyz_, angle_
        ...
        np.savetxt("results.txt", pose_list)
