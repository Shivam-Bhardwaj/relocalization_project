...
for i in range(0, args.iter):
    ...
    # predicted_q = net.blobs[''].data
    # print net.blobs
    # print net.blobs['icp9_pool'].data.shape
    # image = net.blobs['data'].data
    # new =  np.squeeze(image)[2]
    ...
    print "Given 3d coordinate: ",pose_x,"and Predicted 3d coordinates: ", predicted_x
