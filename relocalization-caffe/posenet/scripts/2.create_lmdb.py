...
env = lmdb.open('../../dataset/train_lmdb', map_size=int(1e12))
...
env = lmdb.open('../../dataset/test_lmdb', map_size=int(1e12))
...
env = lmdb.open('../../dataset/validation_lmdb', map_size=int(1e12))
